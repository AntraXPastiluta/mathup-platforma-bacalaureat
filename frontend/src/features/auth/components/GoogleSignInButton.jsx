...
export function GoogleSignInButton({ onClick, loading = false, disabled = false }) {
  return (
    <div className="space-y-6">
      <Button
        type="button"
        variant="outline"
        className="w-full h-14 rounded-xl border-2 bg-white dark:bg-white/5 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-white/10 normal-case tracking-normal font-bold text-sm"
        onClick={onClick}
